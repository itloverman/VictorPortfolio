...
export default function index() {
    return <>
    <Head>
        <title>Tymoshchuk Viktor | Senior FrontEnd Engineer</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Viktor's portfolio. I solve problems using code (Mostly web). Engineer from Somewhere and everywhere."/>
